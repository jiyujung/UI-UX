...
function handleRefresh() {
    console.log("here");
    var url = "http://openapi.seoul.go.kr:8088/62464a4e776a6a353638794c626956/json/SearchSTNTimeTableByIDService/1/2/"+test+"/1/1/"
    $.getJSON(url + "?callback=", updateTraffic);
	var url = "http://openapi.seoul.go.kr:8088/62464a4e776a6a353638794c626956/json/SearchSTNTimeTableByIDService/1/2/"+test+"/1/2/"
	$.getJSON(url + "?callback=", updateTraffic);
}

function updateTraffic(subways) {
	var traffic = subways.SearchSTNTimeTableByIDService.row;
