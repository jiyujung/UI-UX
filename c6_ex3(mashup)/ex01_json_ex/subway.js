...
function handleRefresh() {
    ...
    var url = "http://openapi.seoul.go.kr:8088/62464a4e776a6a353638794c626956/json/CardSubwayStatsNew/1/100/20200101/";
...
function updateTraffic(subwaypeople) {
    ...
    for (var i = 0; i < traffic.length; i++) {
        var div = document.createElement("div");
        div.setAttribute("class", "subwayItem");
        div.innerHTML = " " + traffic[i].USE_DT + "일에 " + traffic[i].LINE_NUM + "에 " + 
                        traffic[i].SUB_STA_NM + "역에서 " + traffic[i].RIDE_PASGR_NUM + "명이 승차하고 "
